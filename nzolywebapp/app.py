...
def listmembers():
    ...
    sql = "SELECT members.MemberID AS 'Member ID', teams.TeamName AS 'Team Name', members.FirstName AS 'First Name', members.LastName AS 'Last Name', members.City, members.Birthdate \
          FROM members \
          INNER JOIN teams \
